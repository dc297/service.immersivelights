...
class CronManager:
    CRONFILE = 'special://profile/addon_data/service.immersivelights/cron.xml'
    ...
    def _readCronFile(self):
        if(not xbmcvfs.exists(xbmcvfs.translatePath('special://profile/addon_data/service.immersivelights/'))):
            xbmcvfs.mkdir(xbmcvfs.translatePath('special://profile/addon_data/service.immersivelights/'))
        adv_jobs = {}
        try:
